...
Shader "Custom/chapter7SingleTexture" {
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f o):SV_Target
			{
				...
				fixed3 specular = _LightColor0.rgb * _Specular.rgb *saturate(dot(halfDir,o.worldNormal));
